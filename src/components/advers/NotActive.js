...
class NotActive extends Component {
  ...
  render() {
    ...
    return (
      <div className="ads_wrapper__item not_active clearfix" style={this.state.deleteIsOpen && window.innerWidth < 992 ? {paddingBottom: '100px'} : null}>
        <div className="left">
          <h2>{title}</h2>
...
export default connect(null, {deleteAd})(NotActive);
