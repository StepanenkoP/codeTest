...
class AfricaCheck extends Component {
      ...
      <div className="checkbox_section">
        ...
        <div className="wrapper">
          <CheckboxGroup
            ...
            onChange={this.props.africaChanged}>
            {allItems}
          </CheckboxGroup>
        </div>
      </div>
...
AfricaCheck.propTypes = {
  title: React.PropTypes.string.isRequired,
  items: React.PropTypes.array.isRequired,
  checkTitle: React.PropTypes.array.isRequired,
  africaChanged: React.PropTypes.func.isRequired,
}

export default AfricaCheck
