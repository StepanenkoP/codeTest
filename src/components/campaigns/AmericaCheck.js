...
class AmericaCheck extends Component {
      ...
      <div className="checkbox_section">
        ...
        <div className="wrapper">
          <CheckboxGroup
            ...
            onChange={this.props.americaChanged}>
            {allItems}
          </CheckboxGroup>
        </div>
      </div>
...
AmericaCheck.propTypes = {
  title: React.PropTypes.string.isRequired,
  items: React.PropTypes.array.isRequired,
  checkTitle: React.PropTypes.array.isRequired,
  americaChanged: React.PropTypes.func.isRequired,
}

export default AmericaCheck
