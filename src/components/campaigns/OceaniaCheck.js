...
class OceaniaCheck extends Component {
      ...
      <div className="checkbox_section">
        ...
        <div className="wrapper">
          <CheckboxGroup
            ...
            onChange={this.props.oceaniaChanged}>
            {allItems}
          </CheckboxGroup>
        </div>
      </div>
...
OceaniaCheck.propTypes = {
  title: React.PropTypes.string.isRequired,
  items: React.PropTypes.array.isRequired,
  checkTitle: React.PropTypes.array.isRequired,
  oceaniaChanged: React.PropTypes.func.isRequired,
}

export default OceaniaCheck
