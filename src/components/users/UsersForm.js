  ...
  render () {
    ...
    const messages = this.props.allMessages !== null && !this.state.preloader ? <div className="messages_wrapper">
      <div className="messages">
        ...
        <div className="messages_row users_row blocked clearfix">
          ...
          <div className="user_block"><div className="block"></div></div>
        </div>
        <div className="messages_row users_row unblocked clearfix">
          <div className="user_id">C01</div>
          <div className="user_name">Chris</div>
          <div className="user_surname">Jones</div>
          <div className="user_date">11/01/2016</div>
...
export default connect (mapStateToProps, {loadAllMessages})(UsersForm);
